...
class MetricsDoubleWindow(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        #Brow Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.BrowHeight, decimals=2)))
        self.photo1Table.setItem(0, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.BrowHeight, decimals=2)))
        self.photo1Table.setItem(0, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.BrowHeight, decimals=2)))
        self.photo1Table.setItem(0, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.BrowHeight, decimals=2)))
        self.photo1Table.setItem(0, 3, val)
        
        #Marginal Reflex Distance 1
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.MarginalReflexDistance1, decimals=2)))
        self.photo1Table.setItem(1, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.MarginalReflexDistance1, decimals=2)))
        self.photo1Table.setItem(1, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.MarginalReflexDistance1, decimals=2)))
        self.photo1Table.setItem(1, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.MarginalReflexDistance1, decimals=2)))
        self.photo1Table.setItem(1, 3, val)
        
        #Marginal Reflex Distance 2
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.MarginalReflexDistance2, decimals=2)))
        self.photo1Table.setItem(2, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.MarginalReflexDistance2, decimals=2)))
        self.photo1Table.setItem(2, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.MarginalReflexDistance2, decimals=2)))
        self.photo1Table.setItem(2, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.MarginalReflexDistance2, decimals=2)))
        self.photo1Table.setItem(2, 3, val)
        
        #Palpebral Fissure Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.PalpebralFissureHeight, decimals=2)))
        self.photo1Table.setItem(3, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.PalpebralFissureHeight, decimals=2)))
        self.photo1Table.setItem(3, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.PalpebralFissureHeight, decimals=2)))
        self.photo1Table.setItem(3, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.PalpebralFissureHeight, decimals=2)))
        self.photo1Table.setItem(3, 3, val)
        
        #Eye Area
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.EyeArea, decimals=2)))
        self.photo1Table.setItem(4, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.EyeArea, decimals=2)))
        self.photo1Table.setItem(4, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.EyeArea, decimals=2)))
        self.photo1Table.setItem(4, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.EyeArea, decimals=2)))
        self.photo1Table.setItem(4, 3, val)
        
        #NLF Angle
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.NLF_angle, decimals=2)))
        self.photo1Table.setItem(5, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.NLF_angle, decimals=2)))
        self.photo1Table.setItem(5, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.NLF_angle, decimals=2)))
        self.photo1Table.setItem(5, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.NLF_angle, decimals=2)))
        self.photo1Table.setItem(5, 3, val)
        
        #Upper Lip Slope
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.UpperLipSlope, decimals=2)))
        self.photo1Table.setItem(6, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.UpperLipSlope, decimals=2)))
        self.photo1Table.setItem(6, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.UpperLipSlope, decimals=2)))
        self.photo1Table.setItem(6, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.UpperLipSlope, decimals=2)))
        self.photo1Table.setItem(6, 3, val)
        
        #Commisure Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.CommisureHeight, decimals=2)))
        self.photo1Table.setItem(7, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.CommisureHeight, decimals=2)))
        self.photo1Table.setItem(7, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.CommisureHeight, decimals=2)))
        self.photo1Table.setItem(7, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.CommisureHeight, decimals=2)))
        self.photo1Table.setItem(7, 3, val)
        
        #Dental Show
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.InterlabialDistance, decimals=2)))
        self.photo1Table.setItem(8, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.InterlabialDistance, decimals=2)))
        self.photo1Table.setItem(8, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.InterlabialDistance, decimals=2)))
        self.photo1Table.setItem(8, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.InterlabialDistance, decimals=2)))
        self.photo1Table.setItem(8, 3, val)
        
        #Dental Show Area
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo1Table.setItem(9, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo1Table.setItem(9, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo1Table.setItem(9, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo1Table.setItem(9, 3, val)
        
        #Commissure Position
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.CommissurePosition, decimals=2)))
        self.photo1Table.setItem(10, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.CommissurePosition, decimals=2)))
        self.photo1Table.setItem(10, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.CommissurePosition, decimals=2)))
        self.photo1Table.setItem(10, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.CommissurePosition, decimals=2)))
        self.photo1Table.setItem(10, 3, val)
        
        #Lower Lip Height Deviation
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight1.LowerLipHeight, decimals=2)))
        self.photo1Table.setItem(11, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft1.LowerLipHeight, decimals=2)))
        self.photo1Table.setItem(11, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation1.LowerLipHeight, decimals=2)))
        self.photo1Table.setItem(11, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual1.LowerLipHeight, decimals=2)))
        ...
        #Brow Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.BrowHeight, decimals=2)))
        self.photo2Table.setItem(0, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.BrowHeight, decimals=2)))
        self.photo2Table.setItem(0, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.BrowHeight, decimals=2)))
        self.photo2Table.setItem(0, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.BrowHeight, decimals=2)))
        self.photo2Table.setItem(0, 3, val)
        
        #Marginal Reflex Distance 1
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.MarginalReflexDistance1, decimals=2)))
        self.photo2Table.setItem(1, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.MarginalReflexDistance1, decimals=2)))
        self.photo2Table.setItem(1, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.MarginalReflexDistance1, decimals=2)))
        self.photo2Table.setItem(1, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.MarginalReflexDistance1, decimals=2)))
        self.photo2Table.setItem(1, 3, val)
        
        #Marginal Reflex Distance 2
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.MarginalReflexDistance2, decimals=2)))
        self.photo2Table.setItem(2, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.MarginalReflexDistance2, decimals=2)))
        self.photo2Table.setItem(2, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.MarginalReflexDistance2, decimals=2)))
        self.photo2Table.setItem(2, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.MarginalReflexDistance2, decimals=2)))
        self.photo2Table.setItem(2, 3, val)
        
        #Palpebral Fissure Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.PalpebralFissureHeight, decimals=2)))
        self.photo2Table.setItem(3, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.PalpebralFissureHeight, decimals=2)))
        self.photo2Table.setItem(3, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.PalpebralFissureHeight, decimals=2)))
        self.photo2Table.setItem(3, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.PalpebralFissureHeight, decimals=2)))
        self.photo2Table.setItem(3, 3, val)
        
        #Eye Area
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.EyeArea, decimals=2)))
        self.photo2Table.setItem(4, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.EyeArea, decimals=2)))
        self.photo2Table.setItem(4, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.EyeArea, decimals=2)))
        self.photo2Table.setItem(4, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.EyeArea, decimals=2)))
        self.photo2Table.setItem(4, 3, val)
        
        #NLF Angle
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.NLF_angle, decimals=2)))
        self.photo2Table.setItem(5, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.NLF_angle, decimals=2)))
        self.photo2Table.setItem(5, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.NLF_angle, decimals=2)))
        self.photo2Table.setItem(5, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.NLF_angle, decimals=2)))
        self.photo2Table.setItem(5, 3, val)
        
        #Upper Lip Slope
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.UpperLipSlope, decimals=2)))
        self.photo2Table.setItem(6, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.UpperLipSlope, decimals=2)))
        self.photo2Table.setItem(6, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.UpperLipSlope, decimals=2)))
        self.photo2Table.setItem(6, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.UpperLipSlope, decimals=2)))
        self.photo2Table.setItem(6, 3, val)
        
        #Commisure Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.CommisureHeight, decimals=2)))
        self.photo2Table.setItem(7, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.CommisureHeight, decimals=2)))
        self.photo2Table.setItem(7, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.CommisureHeight, decimals=2)))
        self.photo2Table.setItem(7, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.CommisureHeight, decimals=2)))
        self.photo2Table.setItem(7, 3, val)
        
        #Dental Show
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.InterlabialDistance, decimals=2)))
        self.photo2Table.setItem(8, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.InterlabialDistance, decimals=2)))
        self.photo2Table.setItem(8, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.InterlabialDistance, decimals=2)))
        self.photo2Table.setItem(8, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.InterlabialDistance, decimals=2)))
        self.photo2Table.setItem(8, 3, val)
        
        #Dental Show Area
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo2Table.setItem(9, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo2Table.setItem(9, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo2Table.setItem(9, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.photo2Table.setItem(9, 3, val)
        
        #Commissure Position
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.CommissurePosition, decimals=2)))
        self.photo2Table.setItem(10, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.CommissurePosition, decimals=2)))
        self.photo2Table.setItem(10, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.CommissurePosition, decimals=2)))
        self.photo2Table.setItem(10, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.CommissurePosition, decimals=2)))
        self.photo2Table.setItem(10, 3, val)
        
        #Lower Lip Height Deviation
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsRight2.LowerLipHeight, decimals=2)))
        self.photo2Table.setItem(11, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsLeft2.LowerLipHeight, decimals=2)))
        self.photo2Table.setItem(11, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsDeviation2.LowerLipHeight, decimals=2)))
        self.photo2Table.setItem(11, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementsPercentual2.LowerLipHeight, decimals=2)))
        ...
        #Brow Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.BrowHeight, decimals=2)))
        self.sideTable.setItem(0, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.BrowHeight, decimals=2)))
        self.sideTable.setItem(0, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.BrowHeight, decimals=2)))
        self.sideTable.setItem(0, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.BrowHeight, decimals=2)))
        self.sideTable.setItem(0, 3, val)
        
        #Marginal Reflex Distance 1
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.MarginalReflexDistance1, decimals=2)))
        self.sideTable.setItem(1, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.MarginalReflexDistance1, decimals=2)))
        self.sideTable.setItem(1, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.MarginalReflexDistance1, decimals=2)))
        self.sideTable.setItem(1, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.MarginalReflexDistance1, decimals=2)))
        self.sideTable.setItem(1, 3, val)
        
        #Marginal Reflex Distance 2
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.MarginalReflexDistance2, decimals=2)))
        self.sideTable.setItem(2, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.MarginalReflexDistance2, decimals=2)))
        self.sideTable.setItem(2, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.MarginalReflexDistance2, decimals=2)))
        self.sideTable.setItem(2, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.MarginalReflexDistance2, decimals=2)))
        self.sideTable.setItem(2, 3, val)
        
        #Palpebral Fissure Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.PalpebralFissureHeight, decimals=2)))
        self.sideTable.setItem(3, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.PalpebralFissureHeight, decimals=2)))
        self.sideTable.setItem(3, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.PalpebralFissureHeight, decimals=2)))
        self.sideTable.setItem(3, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.PalpebralFissureHeight, decimals=2)))
        self.sideTable.setItem(3, 3, val)
        
        #Eye Area
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.EyeArea, decimals=2)))
        self.sideTable.setItem(4, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.EyeArea, decimals=2)))
        self.sideTable.setItem(4, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.EyeArea, decimals=2)))
        self.sideTable.setItem(4, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.EyeArea, decimals=2)))
        self.sideTable.setItem(4, 3, val)
        
        #NLF Angle
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.NLF_angle, decimals=2)))
        self.sideTable.setItem(5, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.NLF_angle, decimals=2)))
        self.sideTable.setItem(5, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.NLF_angle, decimals=2)))
        self.sideTable.setItem(5, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.NLF_angle, decimals=2)))
        self.sideTable.setItem(5, 3, val)
        
        #Upper Lip Slope
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.UpperLipSlope, decimals=2)))
        self.sideTable.setItem(6, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.UpperLipSlope, decimals=2)))
        self.sideTable.setItem(6, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.UpperLipSlope, decimals=2)))
        self.sideTable.setItem(6, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.UpperLipSlope, decimals=2)))
        self.sideTable.setItem(6, 3, val)
        
        #Commisure Height
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.CommisureHeight, decimals=2)))
        self.sideTable.setItem(7, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.CommisureHeight, decimals=2)))
        self.sideTable.setItem(7, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.CommisureHeight, decimals=2)))
        self.sideTable.setItem(7, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.CommisureHeight, decimals=2)))
        self.sideTable.setItem(7, 3, val)
        
        #Dental Show
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.InterlabialDistance, decimals=2)))
        self.sideTable.setItem(8, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.InterlabialDistance, decimals=2)))
        self.sideTable.setItem(8, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.InterlabialDistance, decimals=2)))
        self.sideTable.setItem(8, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.InterlabialDistance, decimals=2)))
        self.sideTable.setItem(8, 3, val)
        
        #Dental Show Area
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.sideTable.setItem(9, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.sideTable.setItem(9, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.sideTable.setItem(9, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.InterlabialArea_of_the_Hemiface, decimals=2)))
        self.sideTable.setItem(9, 3, val)
        
        #Commissure Position
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.CommissurePosition, decimals=2)))
        self.sideTable.setItem(10, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.CommissurePosition, decimals=2)))
        self.sideTable.setItem(10, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.CommissurePosition, decimals=2)))
        self.sideTable.setItem(10, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.CommissurePosition, decimals=2)))
        self.sideTable.setItem(10, 3, val)
        
        #Lower Lip Height Deviation
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightComparison.LowerLipHeight, decimals=2)))
        self.sideTable.setItem(11, 0, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementRightPercentComparison.LowerLipHeight, decimals=2)))
        self.sideTable.setItem(11, 1, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftComparison.LowerLipHeight, decimals=2)))
        self.sideTable.setItem(11, 2, val)
        val = QtWidgets.QTableWidgetItem(str(np.round(self._MeasurementLeftPercentComparison.LowerLipHeight, decimals=2)))
