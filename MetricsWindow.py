...
class MetricsWindow(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        # self.resultTable.horizontalHeader().sectionClicked.connect(self.get_new_photo)
    ...
    #     """This function is for when the user selects the Brow height header on the table 
    #     which will show a picture of an example"""
    #     i = self.resultTable.currentItem()
    #     if i.row() == 0:
    #         pixmap = QtGui.QPixmap('./Metrics/Brow_Height.jpg')
    #         self.metricsLabel.setPhoto(pixmap)
    #         self.metricsLabel.update_view()
